**jenkinsctl** is a jenkins CLI based on [gojenkins](https://github.com/vcscsvcscs/gojenkins) library. 🚀
...
```
$ git clone https://github.com/vcscsvcscs/gojenkins/cli/jenkinsctl.git
$ cd jenkinsctl
$ make
```
